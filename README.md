...
Once the `conda-forge` channel has been enabled, `regi0` can be installed with:

```
conda install regi0
```

It is possible to list all of the versions of `regi0` available on your platform with:
